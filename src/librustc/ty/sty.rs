...
impl<'a, 'tcx, 'gcx> ExistentialProjection<'tcx> {
    pub fn from_ty_ref_and_name(
        tcx: TyCtxt, ty: Ty<'tcx>, trait_ref: ty::ExistentialTraitRef<'tcx>, item_name: Name,
...
impl<'a, 'tcx, 'gcx> PolyExistentialProjection<'tcx> {
    pub fn item_name(&self, tcx: TyCtxt) -> Name {
        self.skip_binder().item_name(tcx)
    }
